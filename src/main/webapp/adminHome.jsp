...
{}%> 
    ...
    <hr class="new1">
  <center><h5>Note: Any errors occur then contact rajashree.ragade1111@gmail.com
Designed & Developed by Edubridge Student</h5></center>
  <hr class="new1">
<center><h5>All Right Reserved @ DGI :: 2021-2022</h5></center> 
  <hr class="new1">
<br>
</body>
</html>